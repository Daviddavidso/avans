<?php
/* ==========================================================================
   БЭКЕНД ПАНЕЛИ УПРАВЛЕНИЯ «MFE». Один файл, нужен только PHP.
...
/* На сайте есть форма «Помощь с выбором» — приём заявок включён. Выключить
   вместе с формой: тогда адрес api.php перестанет принимать что-либо
   от посторонних. */
...
if ($action === 'lead') {
    ...
    $titles = [
        ...
        'rko'     => 'Счёт для бизнеса',
        'unknown' => 'Пока не знаю, нужен совет',
    ];
